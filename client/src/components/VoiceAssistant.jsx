...
export default function VoiceAssistant() {
  ...
  useEffect(() => {
    if (!browserSupportsSpeechRecognition) {
      console.warn('[VoiceAssistant] Browser does not support speech recognition');
      return;
    }

    if (!selectedVoice) {
      console.log('[VoiceAssistant] Waiting for voice to be loaded...');
      return;
    }
  ...
  }, [hasWelcomed, selectedVoice, browserSupportsSpeechRecognition]);
